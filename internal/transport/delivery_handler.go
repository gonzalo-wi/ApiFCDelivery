...
// CreateDeliveryFromContactCenter maneja la creación de entregas desde el panel de contact center
// POST /api/v1/deliveries/contact-center
func (h *DeliveryHandler) CreateDeliveryFromContactCenter(c *gin.Context) {
	ctx := c.Request.Context()
	var req dto.InfobipDeliveryRequest
	...
	response := dto.InfobipDeliveryResponse{
		Token:   delivery.Token,
		Message: "Entrega creada exitosamente desde contact center",
	}
